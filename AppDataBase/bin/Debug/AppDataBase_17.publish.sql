...
GO
PRINT N'Creating unnamed constraint on [dbo].[FoulTypes]...';


GO
ALTER TABLE [dbo].[FoulTypes]
    ADD DEFAULT '' FOR [UIKey];


GO
PRINT N'Creating unnamed constraint on [dbo].[GameEventTypes]...';


GO
ALTER TABLE [dbo].[GameEventTypes]
    ADD DEFAULT '' FOR [UIKey];


GO
PRINT N'Creating unnamed constraint on [dbo].[GoalTypes]...';
