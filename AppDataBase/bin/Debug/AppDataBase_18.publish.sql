...
GO
/*
The column [dbo].[GameEvents].[GameID] on table [dbo].[GameEvents] must be added, but the column has no default value and does not allow NULL values. If the table contains data, the ALTER script will not work. To avoid this issue you must either: add a default value to the column, mark it as allowing NULL values, or enable the generation of smart-defaults as a deployment option.
*/
...
GO
PRINT N'Altering [dbo].[GameEvents]...';


GO
ALTER TABLE [dbo].[GameEvents]
    ADD [GameID] UNIQUEIDENTIFIER NOT NULL;


GO
PRINT N'Creating [dbo].[FK_GameEvents_Games]...';


GO
ALTER TABLE [dbo].[GameEvents] WITH NOCHECK
    ADD CONSTRAINT [FK_GameEvents_Games] FOREIGN KEY ([GameID]) REFERENCES [dbo].[Games] ([ID]);
...
GO
ALTER TABLE [dbo].[GameEvents] WITH CHECK CHECK CONSTRAINT [FK_GameEvents_Games];
